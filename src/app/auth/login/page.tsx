      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600 dark:text-gray-300">
            Servicios de Infraestructura y Cloud
          </p>
        </div>
          ...
          <div className="text-center">
            <div className="text-sm text-gray-600">
              ...
              <div className="mt-2 space-y-1 text-xs">
                <p><strong>Super Admin:</strong> superadmin@onpoint.com / password</p>
                <p><strong>Admin:</strong> admin@onpoint.com / password</p>
                <p><strong>Ejecutivo:</strong> ejecutivo@onpoint.com / password</p>
              </div>
            </div>
          </div>
        </form>
