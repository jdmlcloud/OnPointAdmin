...
export class DynamoDBUserRepository {
  ...
  private initializeMockData() {
    this.users = [
      {
        id: 'dynamodb_user_1',
        email: 'admin@tallerimpresion.com',
      ...
      {
        id: 'dynamodb_user_2',
        email: 'carlos@tallerimpresion.com',
        name: 'Carlos Rodríguez - Operador de Impresión',
        role: 'user',
        status: 'active',
        createdAt: '2024-01-16T09:30:00Z',
        updatedAt: '2024-01-16T09:30:00Z',
        cognitoId: 'cognito_operator_456',
      },
      {
        id: 'dynamodb_user_3',
        email: 'ana@tallerimpresion.com',
        name: 'Ana Martínez - Diseñadora',
        role: 'user',
        status: 'active',
        createdAt: '2024-01-17T14:20:00Z',
        updatedAt: '2024-01-17T14:20:00Z',
        cognitoId: 'cognito_designer_789',
      },
      {
        id: 'dynamodb_user_4',
        email: 'luis@tallerimpresion.com',
        name: 'Luis Fernández - Vendedor',
        role: 'user',
        status: 'active',
        createdAt: '2024-01-18T11:45:00Z',
        updatedAt: '2024-01-18T11:45:00Z',
        cognitoId: 'cognito_sales_101',
      },
      {
        id: 'dynamodb_user_5',
        email: 'nuevo@tallerimpresion.com',
        name: 'Pedro Sánchez - Operador Nuevo',
        role: 'user',
        status: 'pending',
